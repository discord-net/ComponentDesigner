...
partial class CXSourceText
{
    ...
    internal sealed class ChangedText : CXSourceText
    {
        ...
        /// <summary>
        ///     Constructs a new <see cref="CXSourceText.ChangedText"/>.
        /// </summary>
        ...
        /// <summary>
        ///     Determines if the this <see cref="CXSourceText.ChangedText"/> was changed from the provided
        ...
        ///     <see cref="CXSourceText.ChangedText"/>; otherwise <see langword="false"/>.
        /// </returns>
        ...
        /// <summary>
        ///     Computes the changes between a given <see cref="CXSourceText"/> and a <see cref="CXSourceText.ChangedText"/>.
        /// </summary>
        /// <param name="oldText">The <see cref="CXSourceText"/> to start getting changes from.</param>
        /// <param name="newText">The <see cref="CXSourceText.ChangedText"/> buck to stop at.</param>
        /// <returns>
