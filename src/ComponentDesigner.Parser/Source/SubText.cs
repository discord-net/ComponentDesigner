...
partial class CXSourceText
{
    ...
    internal sealed class SubText : CXSourceText
    {
        ...
        /// <summary>
        ///     Constructs a new <see cref="CXSourceText.SubText"/>.
        /// </summary>
        ...
        /// <summary>
        ///     Gets a span that represents a region within this <see cref="CXSourceText.SubText"/>, normalized to the underlying
        ///     <see cref="CXSourceText"/>.
        /// </summary>
        /// <param name="span">The span to composite.</param>
        /// <returns>
        ///     A composited span, relative to this <see cref="CXSourceText.SubText"/>s span, normalized to the underlying
        ///     <see cref="CXSourceText"/>.
        /// </returns>
